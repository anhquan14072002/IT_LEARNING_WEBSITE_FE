    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen">
        <p className="text-xl font-bold mb-4">
          Bạn phải đăng nhập để xem đề thi này
        </p>
        <button
  ...
  return (
    <NotifyProvider>
      ...
      <div className="m-3 pl-5 ">
        ...
        <div className="h-screen w-full flex mt-5 justify-center  items-start">
          ...
          {data?.urlDownloadSolutionFile && (
            <div>
              <a href={data?.urlDownloadSolutionFile}>
                <button className="bg-blue-600 mt-5  text-white p-2 text-sm font-normal border border-blue-500 ">
                  {" "}
                  Tải Lời Giải
                </button>
              </a>{" "}
