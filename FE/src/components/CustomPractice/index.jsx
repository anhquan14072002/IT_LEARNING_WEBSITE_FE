      ...
      >
        ...
        {document?.difficulty === 1 && (
          <div className="mt-3 text-center">
            <span className="bg-yellow-500 text-white rounded-lg p-2">{document?.difficultyName}</span>
          </div>
        )}
        {document?.difficulty === 2 && (
          <div className="mt-3 text-center">
            <span className="bg-green-500 text-white rounded-lg p-2">{document?.difficultyName}</span>
          </div>
        )}
        {document?.difficulty === 3 && (
          <div className="mt-3 text-center">
            <span className="bg-red-500 text-white rounded-lg p-2">{document?.difficultyName}</span>
          </div>
        )}
      </div>
    </div>
